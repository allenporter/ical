...
def test_duration() -> None:
    ...
    with pytest.raises(
        CalendarParseError,
        match="The calendar is not valid: Failed to parse TODO component: Value error, Only one of due or duration may be set.",
    ):
        Todo(
    ...
    with pytest.raises(
        CalendarParseError,
        match="^The calendar is not valid: Failed to parse TODO component: Value error, Duration requires that dtstart is specified$",
    ):
