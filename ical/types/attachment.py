"""Library for parsing and encoding ATTACH values."""
...
@DATA_TYPE.register("ATTACH", disable_value_param=True)
class Attachment(BaseModel):
    """A value type for a property that contains an attachment."""

    uri: Optional[Uri] = None
    """The attachment as a uri."""

    content: Optional[bytes] = None
    """The attachment as base64-encoded binary data."""

    fmttype: Optional[str] = Field(alias="FMTTYPE", default=None)
    """The format type of the attachment."""
    ...
    @classmethod
    def parse_attachment(cls, values: dict[str, Any]) -> dict[str, Any]:
